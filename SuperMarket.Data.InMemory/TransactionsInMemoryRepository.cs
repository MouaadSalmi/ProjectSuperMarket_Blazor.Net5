...
{
    public class TransactionsInMemoryRepository : ITransactionsManagementRepository
    {
        //Transactions report
        private List<Transa> transactions;

        public TransactionsInMemoryRepository()
        {
            transactions = new List<Transa>();
        }
